...
export function AdminNotificationBell({
  ...
  return (
    <div className="relative" ref={containerRef}>
      ...
      {open && (
        // Fixed with viewport-relative inset margins below sm - anchoring
        // this to the bell's own tight-fit container (as the sm+ version
        // does) puts a 320px-wide panel further left than a narrow phone
        // screen has room for, clipping its left edge off-screen.
