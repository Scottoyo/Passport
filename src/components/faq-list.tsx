...
// Shared by the national /faq page and any region-scoped FAQ page (e.g.
// /florida/orlando/faq) so the content and its accessible markup exist in
// exactly one place - callers just supply their own heading/wrapper.
